...
import 'package:uas_ilhamrizqy/screen_page/page_edit_mahasiswa.dart';
import 'package:uas_ilhamrizqy/screen_page/page_insert_mahasiswa.dart';
...
class _PageUtamaState extends State<PageUtama> {
  ...
  Future<void> getMahasiswa() async {
    try {
      var response = await http.get(Uri.parse('http://192.168.56.1/uas_mobile/listmahasiswa.php'));
  ...
  Future<void> deleteMahasiswa(String id) async {
    try {
      var response = await http.post(
        Uri.parse('http://192.168.56.1/uas_mobile/deletemahasiswa.php'),
        body: {'id': id},
      );
      var jsonData = json.decode(response.body);
